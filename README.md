...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Seenew Hub BF Premium') then
        makefolder('Seenew Hub BF Premium')
    end
    if not _G.Dis and not isfile('Seenew Hub BF Premium/'..Name..'.json') then
        writefile('Seenew Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Seenew Hub BF Premium') and isfile('Seeneww Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Seenew Hub BF Premium/'..Name..'.json'))
...
getgenv()['Update_Setting'] = function(Name)
    if not _G.Dis and isfolder('Seenew Hub BF Premium') and isfile('Seenew Hub BF Premium/'..Name..'.json') then
        writefile('Seenew Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
	elseif not _G.Dis then
        Check_Setting(Name)
    end
...
local win = library:Window("Newxd",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
